          ...
          <div className="space-y-2">
            ...
            {!supportsStroke && (
              <div className="flex items-center w-full mt-1">
                <div className="inline-flex items-center justify-center w-full gap-1 px-2 py-1 text-xs rounded-full bg-slate-100 text-slate-600">
                ...
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    <ChevronDown className="h-4 w-4 opacity-50" />
                        ...
                        <PopoverContent className="p-4 hidden lg:block" style={{ width: 'var(--radix-popover-trigger-width)' }} side="top" align="start" sideOffset={5}>
